  ...
  return (
    <article>
      ...
      <p>
        ...
        now <span className="p--bold">only transported the mail</span>, and only
      ...
      <p>
        Sadly, transporting mail by train is expensive. In 2003, the usage of
        the postal trains was <span className="p--bold">stopped</span> in{" "}
        <span className="p--bold">two phases.</span> In March, the lines
        Brussels-Luik, Brussels-Charleroi and Brussels-Antwerp were discontinued
        and by the end of the year, so was the line Brussels-Ghent. This
        officially marked{" "}
